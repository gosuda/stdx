...
import (
	...
	"github.com/gosuda/stdx/maps/concurrentmap"
)

// createConcurrentMap is a factory function for creating ConcurrentMap instances
func createConcurrentMap[K comparable, V any]() maps.Map[K, V] {
...
func testMapPut(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
...
func testMapGet(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
...
func testMapRemove(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
...
func testMapContainsKey(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
...
func testMapContainsValue(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
...
func testMapSize(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
...
func testMapIsEmpty(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
...
func testMapClear(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
	m.Put("key3", 300)
...
func testMapKeys(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
	m.Put("key3", 300)
...
func testMapValues(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
	m.Put("key3", 300)
...
func testMapEntries(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
	m.Put("key3", 300)
...
func testMapForEach(t *testing.T, factory func() maps.Map[string, int]) {
	m := factory()
	m.Put("key1", 100)
	m.Put("key2", 200)
	m.Put("key3", 300)
