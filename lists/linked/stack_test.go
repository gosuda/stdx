...
import (
	...
	"github.com/gosuda/stdx/lists/linked"
)

// createLinkedStack is a factory function for creating LinkedStack instances
func createLinkedStack[T any]() lists.Stack[T] {
	return linked.NewStack[T]()
}

func TestLinkedStack_Push(t *testing.T) {
	testStackPush(t, createLinkedStack[int])
}

func TestLinkedStack_Pop(t *testing.T) {
	testStackPop(t, createLinkedStack[int])
}

func TestLinkedStack_Peek(t *testing.T) {
	testStackPeek(t, createLinkedStack[int])
}

func TestLinkedStack_Size(t *testing.T) {
	testStackSize(t, createLinkedStack[int])
}

func TestLinkedStack_IsEmpty(t *testing.T) {
	testStackIsEmpty(t, createLinkedStack[int])
}

func TestLinkedStack_Clear(t *testing.T) {
	testStackClear(t, createLinkedStack[int])
}

func TestLinkedStack_ToSlice(t *testing.T) {
	testStackToSlice(t, createLinkedStack[int])
}
